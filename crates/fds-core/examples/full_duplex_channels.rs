//! Full-duplex parallel channels on the fds-core primitives.
//!
...
use fds_core::config::TcpConfig;
use fds_core::reactor::{Interest, Reactor};
use fds_core::tcp::{TcpListener, TcpStream as FdsTcp};
